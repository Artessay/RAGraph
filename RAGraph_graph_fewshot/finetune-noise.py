...
for i in range(test_times):
    ...
    best_loss = float('inf')
    finetune_model_name = f"modelset/noise_finetune_rag_model_{args.dataset}_shot{shotnum}_{i}.pkl"
...
with open(f"results/noise_finetune_rag_{args.dataset}_shot{shotnum}.json", "w") as f:
    json.dump({
        "mean": mean_acc,
        "std": std_acc,
