...
class PrePrompt(nn.Module):
    ...
    def embed(self, seq, adj, msk, LP):
        h_1 = self.gcn(seq, adj, LP)
    ...
    def inference(self, features, adj):
        h, _ = self.embed(features, adj, None, False)
        return h
    
    def encode(self, features, adj):
        return self.gcn.encode(features, adj)
    
    def decode(self, embeddings, adj):
        return self.gcn.decode(embeddings, adj)
