...
class ToyGraphBase:
    def __init__(self, pretrain_model, num_class, emb_size, query_graph_hop, retrieve_num) -> None:
        # construct phase
    ...
    def _build_toy_graph_base(self, features, adj, node_labels):
        for aug_features, aug_adj in Augmentation.augment_graph(self.num_augment_scale, features, adj):
            embedddings = self.pretrain_model.encode(aug_features, aug_adj)
