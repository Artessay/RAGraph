...
def parse_args():
    parser = argparse.ArgumentParser(description='RAGraph')
    ...
    parser.add_argument('--data_path', type=str, default="dataset/taobao", help='where to load data')
    parser.add_argument('--exp_name', type=str, default='RAGraph')
    parser.add_argument('--desc', type=str, default='')
    parser.add_argument('--ab', type=str, default='full')
    parser.add_argument('--log', type=int, default=1)

    parser.add_argument('--device', type=str, default="cuda")
    parser.add_argument('--model', type=str, default='RAGraph')
    parser.add_argument('--pre_model', type=str, default='RAGraph')
    parser.add_argument('--f_model', type=str, default='RAGraph')
    parser.add_argument('--pre_model_path', type=str, default='pretrained_weights/GraphPro_Taobao_pretrained.pt')
    ...
    parser.add_argument('--retrieve_num', type=int, default=1)
    parser.add_argument('--retrieve_weight', type=float, default=0.1)
...
if args.model in ['SimGCL', 'GraphPro', 'RAGraph']:
